...
for this, we will need to load in additional data. more specifically, we will need to retrieve historical time series data from the census tracking educational attainment for individuals aged 25 years and ove
